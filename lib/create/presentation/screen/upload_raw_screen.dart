              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        widget.state.selectedUploadType == AiConstant.inputText
                            ? Colors.blue
                            : Colors.grey,
                  ),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        widget.state.selectedUploadType == AiConstant.inputImage
                            ? Colors.blue
                            : Colors.grey,
                  ),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        widget.state.selectedUploadType == AiConstant.inputFile
                            ? Colors.blue
                            : Colors.grey,
                  ),
            ...
            if (widget.state.selectedUploadType == AiConstant.inputText) ...[
              ...
              if (widget.state.pdfBytes != null) ...[
                ...
                Container(
                  ...
                  child: PdfPreview(
                    build: (format) => widget.state.pdfBytes!,
                    maxPageWidth: 400,
                    allowPrinting: false,
                    allowSharing: false,
