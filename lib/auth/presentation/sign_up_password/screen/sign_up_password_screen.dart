                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        ...
                        style: AppTextStyle.bodyRegular.copyWith(color: AppColor.lighterGray),
                      ),
                    ),
                    const Gap(32),

                    // 비밀번호 입력 필드
                    Text('비밀번호', style: AppTextStyle.labelMedium.copyWith(color: AppColor.lightGray)),
                    const Gap(8),
                    TextField(
                    ...
                    // 비밀번호 확인 필드
                    Text('비밀번호 확인', style: AppTextStyle.labelMedium.copyWith(color: AppColor.lightGray)),
                    const Gap(8),
                    TextField(
                    ...
                    // 비밀번호 강도 표시
                    const Text('비밀번호 강도', style: AppTextStyle.captionRegular),
                    const Gap(8),
                    Row(
                      children: [
                        for (int i = 0; i < 4; i++)
