...
class SignUpPasswordViewModel extends _$SignUpPasswordViewModel {
  ...
  Future<void> submitForm() async {
    if (!state.isFormValid) {
      ref.showSnackBar('입력 정보를 확인해주세요.');
      return;
    }

    // 로딩 상태로 변경
    state = state.copyWith(hasSignUpInfoBeenSent: const AsyncValue.loading());
    ...
    try {
            ...
            case Success():
              ...
              switch (saveUserResult) {
                case Success():
                  ...
                  ref.navigate(Routes.signUpComplete);
                  return;
                case Error(error: final saveError):
                  ...
                  ref.showSnackBar(saveError.message);
                  return;
              }
      ...
      ref.showSnackBar('알 수 없는 오류가 발생했습니다.');
    }
  }
}
