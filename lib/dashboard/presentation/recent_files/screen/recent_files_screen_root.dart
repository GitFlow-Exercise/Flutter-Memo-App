...
import 'package:mongo_ai/dashboard/presentation/recent_files/screen/recent_files_screen.dart';

class RecentFilesScreenRoot extends ConsumerStatefulWidget {
  const RecentFilesScreenRoot({super.key});

  @override
  ConsumerState<RecentFilesScreenRoot> createState() => _RecentFilesScreenRootState();
}

class _RecentFilesScreenRootState extends ConsumerState<RecentFilesScreenRoot> {
  ...
  void _handleAction(RecentFilesAction action) {
